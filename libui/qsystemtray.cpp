...
// Constructor.
QSystemTray::QSystemTray ( QWidget *pParent , const char *pszName )
...
// Default destructor.
QSystemTray::~QSystemTray (void)
{
}

// Inherited mouse event.
void QSystemTray::mousePressEvent ( QMouseEvent *pMouseEvent )
{
...
void QSystemTray::setPixmapOverlay ( const QPixmap& pmOverlay )
{
...
void QSystemTray::setPixmap( const QPixmap& pm)
{
	QLabel::setPixmap(pm);
	return;
}

QPopupMenu* QSystemTray::contextMenu()
{
	return contextmenu;
}
